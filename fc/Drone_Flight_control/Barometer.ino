void calculate_pressure() {
  ...
  if (commandedThrust < 1450 && commandedThrust > 1400) {
    ...
    manual_throttle = 0;
    if (commandedThrust > 1450) {
      manual_altitude_change = 1;
      pid_altitude_setpoint = actual_pressure;
      manual_throttle = (commandedThrust - 1450) / 3;
    }
    if (commandedThrust < 1400) {
      manual_altitude_change = 1;
      pid_altitude_setpoint = actual_pressure;
      manual_throttle = (commandedThrust - 1400) / 5;
    }
