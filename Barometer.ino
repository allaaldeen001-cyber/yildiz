void calculate_pressure()
{
  ...
  // Check if altitude hold switch is active (LOW = active)
  bool altHoldActive = (digitalRead(ALT_HOLD_SWITCH) == LOW);
  
  if (altHoldActive && thrust > 1400 && thrust < 1450)
  {
