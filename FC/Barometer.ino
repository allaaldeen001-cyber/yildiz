/*
 * Barometer Module - MS5611 Altitude Hold
 * This file contains the altitude hold PID control using MS5611 barometer
 */

void calculate_pressure() {
  if (counter == 0) {  // Read every 10 iterations
    MS5611.read();
  ...
  if (switch2 == 0 && thrust > 1400 && thrust < 1450) {
    ...
    if (switch2 == 0 && thrust < 1450 && thrust > 1400) {
      ...
      // Manual altitude change detection
      ...
      // Adaptive P-gain based on error
      ...
      pid_output_altitude = (100 * (pid_p_gain_altitude + pid_error_gain_altitude) * pid_error_temp + 
